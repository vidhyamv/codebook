...
export default function Checkout({setCheckout}) {
  ...
  async function handleOrderSubmit(e) {
    ...
    try{
      // const response = await fetch('http://localhost:8000/orders',header);
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="py-6 px-6 lg:px-8">
              ...
              <form onSubmit={handleOrderSubmit} className="space-y-5" >
                ...
                <button type="submit" className="inline-block w-full text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700" >
